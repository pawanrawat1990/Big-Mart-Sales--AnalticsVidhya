...
# hist(training$Item_Outlet_Sales)
# training$ln_Item_Outlet_Sales <- log(training$Item_Outlet_Sales+1)
...
# xg_t1 <- cbind(testing,pred_sales=predict(xgb_fit4,xg_testing))
# write.csv(xg_t1[,c("pred_sales","Item_Identifier","Outlet_Identifier")], file= "D:/R Analytics/Analytics Vidhya/Big Mart/.xg_boost.csv")
